...
import (
	...
	"github.com/Arcazulus/kaspawd/cmd/kaspawwallet/libkaspawwallet/bip32"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"kaspawwallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"kaspawwallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libkaspawwallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
